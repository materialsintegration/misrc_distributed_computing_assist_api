...
※ 2022/01/18：debug/remote-sideディレクトリとそれ以下のファイルは[misrc_distributed_computing_assist_remote_side](https://gitlab.mintsys.jp/midev/misrc_distributed_computing_assist_remote_side.git)に移動した。半年後をめどに削除予定。
## 使い方
